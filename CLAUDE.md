...
# HiveMind repository conventions

This repo collects research questions (`problems/`) and paper summaries (`references/`).
`agent_daily_research/` is a separate, unrelated cloned project — leave it untouched.
...
- **Tags** are a controlled vocabulary in `problems/TAGS.md`. Only use tags from that
  ...
  the list based on the problem statement."
- **References** live in `references/<firstauthor-year>.md` (lowercase; disambiguate
  collisions with a suffix like `richens2024b` or `levine2025-mais`). Follow
